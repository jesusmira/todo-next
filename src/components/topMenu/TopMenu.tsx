  ...
  return (
    ...
    <div className="px-6 flex items-center justify-between space-x-4">
      ...
      <div className="flex space-x-2">
        ...
        <button className="flex items-center justify-center w-10 h-10 rounded-xl border  bg-gray-300 focus:bg-gray-100 active:bg-gray-200 md:hidden">
          <CiSearch size={25} />
        </button>
        <button className="flex items-center justify-center w-10 h-10 rounded-xl border border-gray-300 bg-gray-300 focus:bg-gray-100 active:bg-gray-200">
          <CiChat1 size={25} />
        </button>
        <Link
          href={'/dashboard/cart'} 
          className="p-2 flex items-center justify-center h-10 rounded-xl border border-gray-300  bg-gray-300 focus:bg-gray-100 active:bg-gray-200">
          {
            totalItems > 0 &&(
